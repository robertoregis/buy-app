    ...
    <main class="container mx-auto px-2 lg:px-4 max-w-4xl">
        <div class="space-y-6">
            ...
            <div class="text-center space-y-3">
                <div class="space-y-1">
                    <h2 class="text-2xl lg:text-3xl font-bold text-gray-800">Executar Compra</h2>
            ...
            <div 
                v-if="!purchase.is_in_progress"
                class="bg-orange-50 border-l-4 border-orange-400 rounded-lg p-2 lg:p-4 shadow-sm"
            >
                <div class="flex items-start space-x-3">
                    <div class="flex-shrink-0">
                        <svg class="w-4 h-4 lg:w-5 lg:h-5 text-orange-600 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <!-- Totals Card -->
            <div class="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl shadow-sm p-3 lg:p-6 border border-gray-100">
            ...
            <section v-if="purchase.is_in_progress" class="space-y-4">
                <div v-if="loading" class="text-center p-4 md:p-6 lg:p-10 bg-white rounded-xl shadow-sm border border-gray-200">
                ...
                <div v-else class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    <div class="p-3 lg:p-6">
                        ...
                        <div 
                            ...
                            class="flex flex-col sm:flex-row justify-between items-center pt-6 mt-6 border-t border-gray-200 space-y-2 sm:space-y-0"
                        >
                            <button 
                            ...
                            <div class="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-3">
                                ...
                                <button 
                                    ...
                                    class="cursor-pointer bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-lg font-medium transition-all duration-200 shadow-sm hover:shadow-md flex items-center space-x-2"
                                >
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                    </svg>
