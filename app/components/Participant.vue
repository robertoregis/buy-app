...
<template>
  ...
  >
    ...
    >
      <!-- Cabeçalho do modal -->
      <div class="text-xl font-semibold mb-2">{{participant.name}}</div>
            ...
            <div class="grid grid-cols-1">
              <div class="col-span-1">
                <div class="flex flex-col">
                  <div class="flex">
                    <div>
                      <img :src="participant.image_url" alt="" class="w-[140px] rounded-full">
                    </div>
                  </div>
                  <div class="flex flex-col mt-2">
                    <h2 class="font-[600]">Nome:</h2>
                    <p>{{ participant.name }}</p>
                  </div>
                  <div class="flex flex-col mt-2">
                    <h2 class="font-[600]">E-mail:</h2>
